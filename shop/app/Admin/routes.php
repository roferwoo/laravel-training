...
Route::group([
    ...
    $router->post('coupon_codes', 'CouponCodesController@store');// 新增保存
    $router->get('coupon_codes/create', 'CouponCodesController@create');// 新增页面
    $router->get('coupon_codes/{id}/edit', 'CouponCodesController@edit');// 编辑页面
    $router->put('coupon_codes/{id}', 'CouponCodesController@update');// 编辑保存
    $router->delete('coupon_codes/{id}', 'CouponCodesController@destroy');// 删除
